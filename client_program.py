...
if __name__ == "__main__":
    ...
    model_name = "10_3_epochs_300_dimensions_4_context_2_negative_0001_learning_rate"
    ...
    client_program = ClientProgram(
        client_name=client_name, model_name=model_name, num_context_words=4, num_negative_samples=2)
