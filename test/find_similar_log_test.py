...
if __name__ == "__main__":
    W1 = np.load("models/2_clients_2_context_10_5_epochs/W1_word2vec.npy")
    W2 = np.load("models/2_clients_2_context_10_5_epochs/W2_word2vec.npy")
    word_dict_path = "models/2_clients_2_context_10_5_epochs"
